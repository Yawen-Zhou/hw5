qui {
	...
	if 1 { //Log, Settings, Macros, Workdirectory, Data
		...
		clear 
		capture log close 
		log using hw5.Zhou.Yawen.log, replace 
		local output "/users/d/desktop" 
		global url "https://raw.githubusercontent.com/Yawen-Zhou/hw1/main/hw1.do" //you all have your own URLs, this is one of your peers just for demo purposes
